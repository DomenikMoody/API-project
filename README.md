...
* Request
  * Method: "post"
  * URL: /spot/review/:reviewId/image/create
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: "put"
  * URL: /spot/review/:reviewId/update
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: "delete"
  * URL: spot/:spotId/review/:reviewId/delete
  * Body: none
...
* Request
  * Method: "post"
  * URL: /spot/:spotId/booking/create
  * Body:
